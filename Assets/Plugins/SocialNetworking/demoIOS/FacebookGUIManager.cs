...
public class FacebookGUIManager : Prime31.MonoBehaviourGUI
{
	...
	private void secondColumnAdditionalButtonsGUI()
	{
		...
		if( GUILayout.Button( "Custom REST Request" ) )
		{
			...
			dict.Add( "url", "https://www.facebook.com/pages/Prime31/610841578931070?ref=hl" );
			dict.Add( "comment", "The new prime[31] Facebook page is live" );
			
			Facebook.instance.restRequest( "links.post", HTTPVerb.POST, dict, completionHandler );
		}
		...
		*/
		...
		if( GUILayout.Button( "Post Score and Achievement via Open Graph" ) )
		{
